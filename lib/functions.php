 ...
 */
    ...
    function getLangDefaults( $LangCd = '' ) {
        ...
        $fileName = NoNull($LangCd, DEFAULT_LANG);
    ...
    function readLangFile( $LangCd ) {
        ...
        foreach ( $langs as $lang ) {
            $LangFile = LANG_DIR . "/" . strtolower($lang) . ".json";
    ...
    function validateLanguage( $LangCd ) {
        ...
        $fileName = LANG_DIR . '/' . strtolower($lang) . '.json';
        if ( file_exists($fileName) ) { return strtolower($lang); }
