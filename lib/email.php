...
class Email {
    ...
    private function _sendWelcomeEmail($SendMsgTo = '' ) {
        ...
        if ( $Body && $SendTo ) {
        	...
        	$SendName = NoNull(APP_NAME, "Kiroku");
            ...
            $mail->SetFrom(NoNull($SendFrom, $ReplyTo), NoNull($SendName, 'Kiroku'));
            $mail->Subject = "Welcome to Kiroku!";
            $mail->AltBody = "Welcome to Kiroku!\n\n" .
                             ...
                             "We hope you enjoy using the new Kiroku.";
            $mail->MsgHTML( $Body );
